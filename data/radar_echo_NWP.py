...
#                    print(file_list)
    ...
    def _createRadarEchoDict(self):
        ...
        self._radar_echo_df.to_excel('nwp_xin.xlsx')  
    ...
    def saveRadarEchoDataFrame(self, path='data/'):
        ...
        self._radar_echo_df_path = path + '{}_RadarEcho_{}x{}_NWP.pkl'.format(self._place, self._input_shape[0], self._input_shape[1])
