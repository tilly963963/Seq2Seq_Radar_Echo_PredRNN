...
def test_show(model, save_path, model_name,itr):
    ...
    # date_date=[['2017-07-30 19:30', '2017-07-30 19:30']]
    # test_date=[['2017-07-30 19:30', '2017-07-30 19:30']]
    ...
    load_radar_echo_df_path='PredRNN_L4_H64_2017to2018_pick_day/201808240000to6_512x512.pkl'#'PredRNN_L4_H64_overfitting_custom_criterion_2017to2018_pick_day/2017to2018_pick_day.pkl'

    # save_path ='PredRNN_L4_H64_overfitting_custom_criterion_2017to2018_pick_day/'
    if not os.path.isdir(save_path):
        os.makedirs(save_path)
...
if __name__ == "__main__":                
    ...
    date_date= [['2017-07-30 19:30', '2017-07-30 20:30']]
    ...
    radar_echo_storage_path= 'E:/yu_ting/try/NWP/'#'NWP/'
    load_radar_echo_df_path='PredRNN_L4_H64_2017to2018_pick_day/2017to2018_pick_day.pkl'

    save_path ='PredRNN_L4_H64_2017to2018_pick_day/'
...
#    save_path = 'save_2y3m_0918/'
    ...
    #    model_name ='model_8240110_Sun_Moon_Lake_model_itr30000_test_cost0.0007234304212033749.pkl'
        ...
        model_name = 'model_itr14_test_cost18.91832639698994_ssim0.5785416010605339.pkl'
        ...
        test_show(model, save_path, model_name,itr=14)
        # for i in range(1,21):
