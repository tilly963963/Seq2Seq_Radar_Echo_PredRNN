...
def test_show(model, save_path, model_name,itr):
    ...
    load_radar_echo_df_path='PredRNN_L4_H64_2017to2019_pick_day_v4/202008260400to6_512x512.pkl'#None#'PredRNN_L4_H64_overfitting_custom_criterion_2017to2018_pick_day/2017to2018_pick_day.pkl'
...
#    save_path = 'save_2y3m_0918/'
    ...
    #    model_name ='model_8240110_Sun_Moon_Lake_model_itr30000_test_cost0.0007234304212033749.pkl'
        ...
        model_name = 'model_itr20_test_cost25.825287644426925_ssim0.5013898404763579.pkl'
