...
def train(model, ims, real_input_flag, configs, itr, index ,num_of_batch_size):
    ...
    if index == num_of_batch_size-1:
        fn_path='save_3m_itr10_0915/'#!
        fn = 'cost_itr3_mode_haveLayerNorm_3m_itr3.txt'
...
def test(model, test_input_handle, configs, itr):
    ...
    while (test_input_handle.no_batch_left() == False):
        ...
        print("test_ims =",np.array(test_ims).shape)
