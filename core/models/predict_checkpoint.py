...
class InteractionDST_PredRNN(nn.Module):
    def __init__(self, num_layers, num_hidden, configs):
        ...
        print("self.cell_list=",self.cell_list[0].named_parameters())
        print("self.cell_list=",self.cell_list[1].named_parameters())

        # for param in self.cell_list.named_parameters():
