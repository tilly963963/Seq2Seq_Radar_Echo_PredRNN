...
class Model(torch.nn.Module):
    def __init__(self, configs):
        ...
        # sys.exit()https://zhuanlan.zhihu.com/p/79106053
        ...
        self.network, self.optimizer = amp.initialize(self.network, self.optimizer, opt_level="O1")#custom_criterion=O2 
...
# for i, j, k in zip(X, Y, Z):
    # B[:, i, j] = A[:, i, j] + k
        ...
        # Every self.accumulation_steps iterations, call step() and reset gradients:
        if (self.i+1)%self.accumulation_steps == 0:
